...
#define CUST_EINT_LOWPOWER_NUM              0
#define CUST_EINT_LOWPOWER_DEBOUNCE_CN      512
#define CUST_EINT_LOWPOWER_POLARITY         CUST_EINT_POLARITY_LOW
#define CUST_EINT_LOWPOWER_SENSITIVE        CUST_EINT_LEVEL_SENSITIVE
#define CUST_EINT_LOWPOWER_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_ENABLE
